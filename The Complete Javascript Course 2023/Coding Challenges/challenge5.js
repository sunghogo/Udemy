...
const poll = {
  ...
  registerNewAnswer() {
    ...
    // Indivdual Example
    (0 <= answer && answer < this.answers.length && ++this.answers[answer]) ||
...
// 2.
const btnAnsEl = document.querySelector('.poll');
btnAnsEl.addEventListener('click', poll.registerNewAnswer.bind(poll));
